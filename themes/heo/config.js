const CONFIG = {
  ...
  HEO_HERO_CATEGORY_3: { title: 'Switch游戏', url: '/tag/Switch' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HEO_HERO_RECOMMEND_POST_TAG: '推荐',
  HEO_HERO_RECOMMEND_POST_SORT_BY_UPDATE_TIME: false, // 推荐文章排序，为`true`时将强制按最后修改时间倒序
  HERO_RECOMMEND_COVER: 'https://media.st.dl.eccdnx.com/steam/apps/1623730/header_tchinese.jpg?t=1707904340', // 英雄区右侧图片
